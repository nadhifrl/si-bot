...
<html lang="en">
  ...
  <body>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="developer/assets/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="developer/assets/vendors/chart.js/Chart.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="developer/assets/js/off-canvas.js"></script>
    <script src="developer/assets/js/hoverable-collapse.js"></script>
    <script src="developer/assets/js/misc.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="developer/assets/js/dashboard.js"></script>
    <script src="developer/assets/js/todolist.js"></script>
