...
class PrediksiPembelianTiketController extends Controller
{
    /**
    ...
    public function prediksipembeliantiket()
    {
        ...
        //     array_push($x, PembayaranTiket::where('status', 'Sukses')->whereMonth('created_at', $value)->whereYear('created_at', Carbon::now())->get());
        // }
        ...
        // dd($wma)    ;
        return view('admin.prediksipembeliantiket', compact([
            'wma', 'count', 'count1', 'count2',
            'month', 'month1', 'month2', 'month3',
        ]));

        // return view('admin.lonjakanpengunjung', compact(['x']));
    }
