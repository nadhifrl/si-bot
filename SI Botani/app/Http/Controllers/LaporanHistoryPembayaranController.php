...
class LaporanHistoryPembayaranController extends Controller
{
    /**
    ...
    public function index()
    {
        $pembayaran = DB::table('users')
            ...
            ->get();
        return view('admin.laporanpembayaran.index', compact('pembayaran'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.laporanpembayaran.detail', compact('pembayaran'));
    }
